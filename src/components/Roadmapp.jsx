    ...
    const [tabs,setTabs] = useState([
        {
            id:1,
            title:'sign up',
            content:'To join us at starwoodcapital, you first have to register for a new account. To register, click the SIGNUP button at the top of the page and fill the simple form.',
